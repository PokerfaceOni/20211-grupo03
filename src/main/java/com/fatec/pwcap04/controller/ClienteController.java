...
public class ClienteController {
	...
	@GetMapping("/cliente/cadastrarCliente")
	...
	public ModelAndView atualizaCliente(@PathVariable("id") Long id, @Valid Cliente cliente, BindingResult result) {
		...
		umCliente.setRg(cliente.getRg());
		umCliente.setTelefone(cliente.getTelefone());
		umCliente.setDataNasc(cliente.getDataNasc());
		umCliente.setNaturalidade(cliente.getNaturalidade());
		umCliente.setSexo(cliente.getSexo());
